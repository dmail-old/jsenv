...
(function(){
	...
	var Module = Function.create({
		...
		parent: null, // the module who created this one (can be null for dynamic or main module)
		...
		loadDependencies: function(){
			...
			return Promise.all(this.dependencies.map(function(dependencyModule){
				return dependencyModule.toPromise();
