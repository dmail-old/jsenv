		...
		write: function(string){
			...
			while(pos < length){
		        ...
		        if( lineLength < 0 ){
					...
					var noValue = fieldLength < 0, step = 0, field = buffer.slice(pos, pos + (noValue ? lineLength : fieldLength));
					...
					var fieldIndex = pos + step, valueLength = lineLength - step, value = buffer.slice(fieldIndex, fieldIndex + valueLength);
