...
(function(jsenv){
	...
	var loader = {
		...
		setup: function(){
			this.baseURL = new URL(jsenv.baseURL, jsenv.baseURI);

			debug('loader baseURL', this.baseURL);
