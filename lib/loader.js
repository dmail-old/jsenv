...
(function(jsenv){
	...
	var jsenvLoader = Function.extend(es6Loader, {
		...
		read: function(location, options){
			return this.loader.read(location, options);
		},

		write: function(location, body, options){
			return this.loader.write(location, body, options);
		},
	...
	var loader = {
		...
		read: function(location, options){
			throw new Error('loader.read() unimplemented');
		},

		write: function(location, body, options){
			throw new Error('loader.write() unimplemented');
		},
